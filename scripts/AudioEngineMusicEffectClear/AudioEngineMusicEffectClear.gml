/// @desc Clear a music effect from a music category
/// @module Music
/// @url https://turlututu-games.github.io/AudioEngineGML/#/Functions-Music?id=AudioEngineMusicEffectClear
...
function AudioEngineMusicEffectClear(_effectIndex = 0, _category = 0) {
    __AEBusEffectClear(_effectIndex, $"{__AUDIOENGINE_PREFIX_MUSIC}-{_category}")
}
