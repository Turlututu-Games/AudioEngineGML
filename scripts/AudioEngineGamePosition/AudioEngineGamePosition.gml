...
/// @module Game
/// @see https://turlututu-games.github.io/AudioEngineGML/#/Functions-Game?id=AudioEngineGamePosition
...
/// @module Game
/// @see https://turlututu-games.github.io/AudioEngineGML/#/Functions-Game?id=AudioEngineGamePositionAtObject
/// @param {Id.Sound,Struct.__AESystemPlaying} _ref Sound reference
/// @param {Id.Instance,Asset.GMObject} _instance Object instance used to get the position
/// @param {Real} [_z] Z position. Default to 0
/// @return {Undefined}
function AudioEngineGamePositionAtObject(_ref, _instance, _z = 0) {
